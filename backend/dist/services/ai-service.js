...
exports.streamAIAnalysis = streamAIAnalysis;
...
function buildPrompt(analysisType, context, extra) {
...
async function streamAIAnalysis(analysisType, context, res, extra) {
    res.writeHead(200, {
    ...
    try {
        ...
        logger_1.logger.error('AI analysis error', { error });
...
async function runAIAnalysis(analysisType, context, extra) {
    const prompt = buildPrompt(analysisType, context, extra);
